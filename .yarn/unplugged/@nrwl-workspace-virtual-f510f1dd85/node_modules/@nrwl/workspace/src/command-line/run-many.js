...
function runMany(parsedArgs) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const { nxArgs, overrides } = (0, utils_1.splitArgsIntoNxArgsAndOverrides)(parsedArgs, 'run-many');
        ...
        yield (0, run_command_1.runCommand)(projects, projectGraph, env, nxArgs, overrides, nxArgs.hideCachedOutput ? 'hide-cached-output' : 'default', null);
    });
}
