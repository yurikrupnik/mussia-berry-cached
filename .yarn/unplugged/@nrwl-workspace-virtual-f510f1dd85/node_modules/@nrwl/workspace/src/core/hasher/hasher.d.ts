...
export declare const HashFilter: {
    AllFiles: string;
    ExcludeTestsOfAll: string;
    ExcludeTestsOfDeps: string;
};
export declare type HashFilter = typeof HashFilter[keyof typeof HashFilter];
export declare class Hasher {
    ...
    hashTaskWithDepsAndContext(task: Task, filter?: HashFilter): Promise<Hash>;
