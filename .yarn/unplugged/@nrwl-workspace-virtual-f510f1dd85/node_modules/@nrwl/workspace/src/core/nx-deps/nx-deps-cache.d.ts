import type { FileData, NxJsonConfiguration, ProjectFileMap, ProjectGraph, ProjectGraphDependency, ProjectGraphExternalNode, ProjectGraphNode, WorkspaceJsonConfiguration } from '@nrwl/devkit';
