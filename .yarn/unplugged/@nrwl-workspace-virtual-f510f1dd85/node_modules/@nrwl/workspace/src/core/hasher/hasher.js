...
exports.Hasher = exports.HashFilter = void 0;
...
class Hasher {
    ...
    hashTaskWithDepsAndContext(task, filter = exports.HashFilter.AllFiles) {
    ...
    hashSource(task) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            return this.projectHashes.hashProjectNodeSource(task.target.project, exports.HashFilter.AllFiles);
        });
    }
    hashArray(values) {
...
class ProjectHasher {
    ...
    hashProject(projectName, visited, filter) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            return Promise.resolve().then(() => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                const filterForProject = filter === exports.HashFilter.AllFiles ||
                    (filter === exports.HashFilter.ExcludeTestsOfDeps && visited[0] === projectName)
                    ? exports.HashFilter.AllFiles
                    : exports.HashFilter.ExcludeTestsOfAll;
    ...
    hashProjectNodeSource(projectName, filter) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            if (!this.sourceHashes[mapKey]) {
                this.sourceHashes[mapKey] = new Promise((res) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                    var _a, _b;
                    ...
                    const filteredFiles = filter === exports.HashFilter.AllFiles
                        ? p.data.files
    ...
    readTsConfig() {
        ...
        var _b;
        try {
            const res = (0, devkit_1.readJsonFile)((0, typescript_1.getRootTsConfigFileName)());
